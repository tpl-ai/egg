...
export const EXERCISES = {
  ...
  'Cardio': [
    ...
    { name: 'Stairmaster', equipment: 'machine' },
    { name: 'Rowing Machine', equipment: 'machine' },
    { name: 'Running (outdoor)', equipment: 'bodyweight' },
    { name: 'Walking', equipment: 'bodyweight' },
    { name: 'Stairs', equipment: 'bodyweight' },
    { name: 'Jump Rope', equipment: 'equipment' },
  ],
  'Chest': [
  ...
  'Core': [
    ...
    { name: 'Plank', equipment: 'bodyweight', alternatives: ['Dead Bug', 'Side Plank'] },
    { name: 'Side Plank', equipment: 'bodyweight', alternatives: ['Plank', 'Pallof Press'] },
    { name: 'Dead Bug', equipment: 'bodyweight', alternatives: ['Plank', 'Bird Dog'] },
    { name: 'Bird Dog', equipment: 'bodyweight', alternatives: ['Dead Bug', 'Plank'] },
