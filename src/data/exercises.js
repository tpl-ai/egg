...
export const EXERCISES = {
  ...
  'Cardio': [
    { name: 'Running', equipment: 'outdoor', type: 'duration', cardioType: 'running', trackDistance: true, distanceUnit: 'km' },
    { name: 'Running (outdoor)', equipment: 'outdoor', type: 'duration', cardioType: 'running', trackDistance: true, distanceUnit: 'km' },
    { name: 'Treadmill', equipment: 'machine', type: 'duration', cardioType: 'running', trackDistance: true, distanceUnit: 'km' },
    { name: 'Walking', equipment: 'outdoor', type: 'duration', cardioType: 'walking', trackDistance: true, distanceUnit: 'km' },
    { name: 'Hiking', equipment: 'outdoor', type: 'duration', cardioType: 'hiking', trackDistance: true, distanceUnit: 'km', trackElevation: true },
    { name: 'Cycling (outdoor)', equipment: 'outdoor', type: 'duration', cardioType: 'cycling', trackDistance: true, distanceUnit: 'km' },
    { name: 'Stationary Bike', equipment: 'machine', type: 'duration', cardioType: 'cycling' },
    { name: 'Elliptical', equipment: 'machine', type: 'duration', cardioType: 'elliptical', trackDistance: true, distanceUnit: 'km' },
    { name: 'Stairmaster', equipment: 'machine', type: 'duration', cardioType: 'stairs', trackFloors: true },
    { name: 'Stairs', equipment: 'outdoor', type: 'duration', cardioType: 'stairs', trackFloors: true },
    { name: 'Rowing Machine', equipment: 'machine', type: 'duration', cardioType: 'rowing', trackDistance: true, distanceUnit: 'm' },
    { name: 'SkiErg', equipment: 'machine', type: 'duration', cardioType: 'skiing', trackDistance: true, distanceUnit: 'm' },
    { name: 'Swimming', equipment: 'outdoor', type: 'duration', cardioType: 'swimming', trackDistance: true, distanceUnit: 'm' },
    { name: 'Jump Rope', equipment: 'equipment', type: 'duration', cardioType: 'jump_rope' },
  ],
  'Chest': [
